...
abstract_short = "In this paper we first compute the configuration of these two parameters that jointly optimizes throughput performance in terms of proportional fairness. Then, we propose an adaptive algorithm based on control theory that converges to the desired point of operation. Finally, we conduct a control theoretic analysis of the algorithm to find a setting for its parameters that provides a good tradeoff between stability and speed of convergence."
...
# Links (optional).
url_pdf = "https://ieeexplore.ieee.org/document/6195795/"
url_preprint = "/files/papers/2012_garcia-saavedra_infocom_ados.pdf"
# url_code = "#"
# url_dataset = "#"
# url_project = "#"
# url_slides = "#"
